...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1798: () => globalThis.Blob,
      _1799: x0 => x0.name,
      _1800: x0 => x0.length,
      _1813: x0 => x0.continue(),
      _1814: () => globalThis.indexedDB,
      _1827: x0 => globalThis.Object.keys(x0),
      _1828: x0 => x0.length,
      ...
      _1842: (x0,x1) => new WebSocket(x0,x1),
      _1843: (x0,x1) => x0.send(x1),
      _1844: (x0,x1,x2) => x0.close(x1,x2),
      _1845: (x0,x1) => x0.close(x1),
      _1846: x0 => x0.close(),
      _1853: () => new AbortController(),
      _1854: x0 => x0.abort(),
      _1855: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1856: (x0,x1) => globalThis.fetch(x0,x1),
      _1857: (x0,x1) => x0.get(x1),
      _1858: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1858(f,arguments.length,x0,x1,x2) }),
      _1859: (x0,x1) => x0.forEach(x1),
      _1860: x0 => x0.getReader(),
      _1861: x0 => x0.cancel(),
      _1862: x0 => x0.read(),
      _1863: x0 => new BroadcastChannel(x0),
      _1864: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1864(f,arguments.length,x0) }),
      _1865: (x0,x1) => x0.postMessage(x1),
      _1866: x0 => x0.close(),
      _1870: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      ...
      _1878: (a, s) => a.join(s),
      _1879: (a, s, e) => a.slice(s, e),
      _1881: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1882: a => a.length,
      _1883: (a, l) => a.length = l,
      _1884: (a, i) => a[i],
      _1885: (a, i, v) => a[i] = v,
      _1886: (a, t) => a.concat(t),
      _1887: o => {
        if (o === null || o === undefined) return 0;
      ...
      _1891: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1892: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _1893: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1894: o => o instanceof Uint8ClampedArray,
      _1895: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1896: o => o instanceof Uint16Array,
      _1897: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1898: o => o instanceof Int16Array,
      _1899: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1900: o => {
        if (o === null || o === undefined) return 0;
      ...
      _1903: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1905: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1906: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _1907: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1908: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _1909: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1910: (a, i) => a.push(i),
      _1911: (t, s) => t.set(s),
      _1912: l => new DataView(new ArrayBuffer(l)),
      _1913: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1914: o => o.byteLength,
      _1915: o => o.buffer,
      _1916: o => o.byteOffset,
      _1917: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1918: (b, o) => new DataView(b, o),
      _1919: (b, o, l) => new DataView(b, o, l),
      _1920: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1921: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1922: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1923: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1924: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1925: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1926: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1927: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1928: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1929: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1930: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1931: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1934: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1935: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1936: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1937: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1938: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1939: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1947: (module,f) => finalizeWrapper(f, function() { return module.exports._1947(f,arguments.length) }),
      _1948: () => globalThis.Promise.resolve(),
      _1949: (x0,x1) => x0.then(x1),
      _2074: (x0,x1) => { x0.draggable = x1 },
      _2090: x0 => x0.style,
      _2103: (x0,x1) => { x0.oncancel = x1 },
      _2109: (x0,x1) => { x0.onchange = x1 },
      _2149: (x0,x1) => { x0.onerror = x1 },
      _2567: (x0,x1) => { x0.src = x1 },
      _3014: (x0,x1) => { x0.accept = x1 },
      _3028: x0 => x0.files,
      _3054: (x0,x1) => { x0.multiple = x1 },
      _3072: (x0,x1) => { x0.type = x1 },
      _3790: () => globalThis.window,
      _3833: x0 => x0.location,
      _3834: x0 => x0.history,
      _3852: x0 => x0.navigator,
      _4116: x0 => x0.localStorage,
      _4124: x0 => x0.href,
      _4219: x0 => x0.clipboard,
      _4221: x0 => x0.geolocation,
      _4224: x0 => x0.mediaDevices,
      _4226: x0 => x0.permissions,
      _4240: x0 => x0.userAgent,
      _4246: x0 => x0.onLine,
      _4291: x0 => x0.data,
      _4321: x0 => x0.port1,
      _4322: x0 => x0.port2,
      _4326: (x0,x1) => { x0.onmessage = x1 },
      _4336: (x0,x1) => { x0.onmessage = x1 },
      _4398: (x0,x1) => { x0.onerror = x1 },
      _4406: x0 => x0.port,
      _4408: (x0,x1) => { x0.onerror = x1 },
      _4441: x0 => x0.length,
      _4658: x0 => x0.readyState,
      _4671: (x0,x1) => { x0.binaryType = x1 },
      _4674: x0 => x0.code,
      _4675: x0 => x0.reason,
      _6343: x0 => x0.target,
      _6383: x0 => x0.signal,
      ...
      _6537: x0 => x0.body,
      _6866: x0 => x0.tagName,
      _6868: (x0,x1) => { x0.id = x1 },
      _6895: x0 => x0.children,
      _7303: x0 => x0.ctrlKey,
      _7304: x0 => x0.shiftKey,
      _7305: x0 => x0.altKey,
      _7306: x0 => x0.metaKey,
      _8214: x0 => x0.value,
      _8216: x0 => x0.done,
      ...
      _8895: x0 => x0.url,
      _8897: x0 => x0.status,
      _8899: x0 => x0.statusText,
      _8900: x0 => x0.headers,
      _8901: x0 => x0.body,
      _8913: x0 => x0.instance,
      _8915: () => globalThis.WebAssembly,
      _8937: x0 => x0.exports,
      _8945: x0 => x0.buffer,
      _8975: x0 => x0.types,
      _9686: x0 => x0.active,
      _10349: x0 => x0.result,
      _10350: x0 => x0.error,
      _10361: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10363: x0 => x0.oldVersion,
      _10442: x0 => x0.key,
      _10443: x0 => x0.primaryKey,
      _10445: x0 => x0.value,
      _10450: x0 => x0.error,
      _10452: (x0,x1) => { x0.onabort = x1 },
      _10454: (x0,x1) => { x0.oncomplete = x1 },
      _10456: (x0,x1) => { x0.onerror = x1 },
      _10904: (x0,x1) => { x0.alignSelf = x1 },
      _11004: (x0,x1) => { x0.border = x1 },
      _11272: (x0,x1) => { x0.cursor = x1 },
      _11282: (x0,x1) => { x0.display = x1 },
      _11446: (x0,x1) => { x0.height = x1 },
      _11532: (x0,x1) => { x0.margin = x1 },
      _11658: (x0,x1) => { x0.opacity = x1 },
      _12136: (x0,x1) => { x0.width = x1 },
      _12504: x0 => x0.name,
      _12601: x0 => x0.href,
      _12616: x0 => x0.pathname,
      _13221: () => globalThis.console,
      _13245: () => globalThis.document,
      _13247: () => globalThis.console,
      _13252: (x0,x1) => { x0.height = x1 },
      _13254: (x0,x1) => { x0.width = x1 },
      _13256: (x0,x1) => { x0.pointerEvents = x1 },
      _13265: x0 => x0.style,
      _13268: x0 => x0.src,
      _13269: (x0,x1) => { x0.src = x1 },
      _13270: x0 => x0.naturalWidth,
      _13271: x0 => x0.naturalHeight,
      _13286: (x0,x1) => x0.error(x1),
      _13291: x0 => x0.status,
      _13292: (x0,x1) => { x0.responseType = x1 },
      _13294: x0 => x0.response,
