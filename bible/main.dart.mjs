...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CK: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      ...
      EH: x0 => x0.value,
      EI: (x0,x1) => { x0.min = x1 },
      EJ: (x0,x1) => x0.revokeObjectURL(x1),
      EK: (x0,x1) => x0.transferFromImageBitmap(x1),
      EL: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      GJ: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      GK: x0 => x0.width,
      GL: (x0,x1) => x0.get(x1),
      ...
      MJ: (x0,x1) => x0.createObjectURL(x1),
      MK: x0 => x0.convertToBlob(),
      ML: x0 => x0.status,
      ...
      NI: (map, o) => map.get(o),
      NJ: x0 => x0.URL,
      NK: (x0,x1,x2) => new ImageData(x0,x1,x2),
      NL: x0 => x0.getReader(),
      NM: x0 => x0.text(),
      NN: x0 => x0.onLine,
      O: o => o === undefined,
      ...
      PJ: (x0,x1,x2,x3,x4) => ({type: x0,data: x1,premultiplyAlpha: x2,colorSpaceConversion: x3,preferAnimation: x4}),
      ...
      QI: x0 => x0.deref(),
      QJ: x0 => new window.ImageDecoder(x0),
      QK: x0 => x0.allocationSize(),
      QL: x0 => x0.done,
      ...
      UJ: x0 => x0.selectedTrack,
      UK: (x0,x1) => x0.toDataURL(x1),
      UL: x0 => x0.signal,
      ...
      VI: (x0,x1) => x0.error(x1),
      VJ: x0 => x0.completed,
      VK: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      VL: x0 => x0.abort(),
      ...
      cK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      cL: x0 => x0.metaKey,
      cM: x0 => x0.mediaDevices,
      ...
      eI: x0 => x0.data,
      eJ: x0 => x0.image,
      eK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      eL: x0 => x0.ctrlKey,
      eM: (x0,x1) => x0.append(x1),
      ...
      gG: x0 => x0.location,
      gH: x0 => x0.readText(),
      gI: (x0,x1) => new SharedWorker(x0,x1),
      gJ: x0 => x0.decode(),
      gK: (x0,x1,x2) => x0.close(x1,x2),
      gL: x0 => x0.code,
      gM: (x0,x1) => { x0.id = x1 },
      ...
      iI: (x0,x1,x2) => x0.postMessage(x1,x2),
      ...
      lJ: x0 => x0.send(),
      lK: (x0,x1) => { x0.binaryType = x1 },
      lL: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      lM: (x0,x1) => { x0.onerror = x1 },
      m: o => [o],
      ...
      mI: (x0,x1,x2) => x0.postMessage(x1,x2),
      mJ: x0 => x0.status,
      mK: (x0,x1) => x0.getRandomValues(x1),
      mL: (x0,x1,x2) => x0.setAttribute(x1,x2),
      mM: (x0,x1) => { x0.oncancel = x1 },
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      nL: (x0,x1) => { x0.cursor = x1 },
      nM: (x0,x1) => { x0.onchange = x1 },
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oI: (x0,x1) => { x0.onerror = x1 },
      oJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      oK: l => new DataView(new ArrayBuffer(l)),
      oL: (x0,x1) => { x0.display = x1 },
      oM: x0 => x0.type,
      ...
      pJ: (x0,x1) => { x0.responseType = x1 },
      pK: (x0,x1) => x0.getItem(x1),
      pL: (x0,x1) => { x0.opacity = x1 },
      pM: x0 => x0.lastModified,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      uH: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      uI: x0 => x0.naturalHeight,
      uJ: (x0,x1) => { x0.margin = x1 },
      uK: x0 => x0.href,
      uL: x0 => x0.altKey,
      uM: x0 => x0.files,
      ...
      vH: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      vI: x0 => x0.naturalWidth,
      vJ: (x0,x1) => { x0.border = x1 },
      vK: x0 => x0.location,
      vL: x0 => x0.ctrlKey,
      vM: (x0,x1) => x0.replaceChildren(x1),
      w: (l, r) => l === r,
      ...
      wH: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      wI: (x0,x1) => x0.createElement(x1),
      wJ: (x0,x1) => { x0.src = x1 },
      wK: (x0,x1) => x0.removeItem(x1),
      wL: (x0,x1) => x0.getAttribute(x1),
      ...
      xH: o => o.byteLength,
      xI: (x0,x1) => { x0.pointerEvents = x1 },
      xJ: (x0,x1) => { x0.height = x1 },
      xK: (x0,x1,x2) => x0.setItem(x1,x2),
      xL: (x0,x1) => x0.closest(x1),
